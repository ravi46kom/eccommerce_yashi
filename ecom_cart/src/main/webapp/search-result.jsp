				...
				<div class="form-group col-md-6">
				  ...
				  <!-- <input class="form-control" placeholder="$0" type="number"> -->
				  	<select class="mr-2 form-control">
						...
						<option value="50">INR 50</option>
						<option value="100">INR 100</option>
						<option value="150">INR 150</option>
...
<div class="row">
		...
		<figure class="card card-product-grid">
			...
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="./product-detail.jsp" class="title">Great item name goes here</a>
					<div class="price-wrap mt-2">
						<span class="price">INR 1280</span>
						<del class="price-old">INR 1980</del>
					</div> <!-- price-wrap.// -->
				</div>
	...
	<div class="col-md-4">
		<figure class="card card-product-grid">
			...
			<figcaption class="info-wrap">
				<div class="fix-height">
					<a href="./product-detail.jsp" class="title">Product name goes here just for demo item</a>
					<div class="price-wrap mt-2">
						<span class="price">INR 1280</span>
					</div> <!-- price-wrap.// -->
				</div>
