...
<tr>
	...
	<td> 
		<div class="price-wrap"> 
			<var class="price">INR1156.00</var> 
			<small class="text-muted"> INR315.20 each </small> 
		</div> <!-- price-wrap .// -->
	</td>
	<td class="text-right"> 
...
<tr>
	...
	<td> 
		<div class="price-wrap"> 
			<var class="price">INR149.97</var> 
			<small  class="text-muted"> INR75.00 each </small>  
		</div> <!-- price-wrap .// -->
	</td>
	<td class="text-right"> 
	<a href="" class="btn btn-danger"> Remove</a>
...
<tr>
	...
	<td> 
		<div class="price-wrap"> 
			<var class="price">INR98.00</var> 
			<small class="text-muted"> INR578.00 each</small> 
		</div> <!-- price-wrap .// -->
	</td>
	<td class="text-right"> 
		<a href="" class="btn btn-danger"> Remove</a>
	...
	<aside class="col-lg-3">
		...
		<div class="card-body">
			<dl class="dlist-align">
			  <dt>Total price:</dt>
			  <dd class="text-right">INR69.97</dd>
			</dl>
			<dl class="dlist-align">
			  <dt>Tax:</dt>
			  <dd class="text-right"> INR10.00</dd>
			</dl>
			<dl class="dlist-align">
			  <dt>Total:</dt>
			  <dd class="text-right text-dark b"><strong>INR59.97</strong></dd>
			</dl>
			<hr>
			<p class="text-center mb-3">
				<img src="./images/misc/payments.png" height="26">
			</p>
			<a href="./place-order.jsp" class="btn btn-primary btn-block"> Checkout </a>
			<a href="./store.jsp" class="btn btn-light btn-block">Continue Shopping</a>
		</div> <!-- card-body.// -->
		</div> <!-- card.// -->
