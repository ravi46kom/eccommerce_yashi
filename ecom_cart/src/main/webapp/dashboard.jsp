<%@page import="com.ecom_cart.entities.User"%>
<%
User user = (User)session.getAttribute("current-user");
if(user == null){
	session.setAttribute("message", "Login to access Data!!");
	...
	<div class="col-lg-3 col-sm-6 col-8 order-2 order-lg-3">
				<div class="d-flex justify-content-end mb-3 mb-lg-0">
					<div class="widget-header">
						<small class="title text-muted"><%= user.getU_name() %> !</small>
						<div> 
							<a href="./index.jsp">Sign Out</a> <span class="dark-transp">  </span>
						</div>
					</div>
...
<div class="container">
	...
	<aside class="col-md-3">
		...
		<br>
		<a class="btn btn-light btn-block" href="index.jsp"> <i class="fa fa-power-off"></i> <span class="text">Log out</span> </a> 
		<!--   SIDEBAR .//END   -->
	</aside>
	<main class="col-md-9">
		<article class="card">
		<header class="card-header">
			...
			<span>Order Date: 20 October 2022</span>
		</header>
		<div class="card-body">
			<div class="row"> 
				<div class="col-md-8">
					...
					<p>Xenonstack <br>  
					Phone +919507233159 Email: internship@Xenonstack.com <br>
			    	Location: Home number, Building name, Street 123,  Mohali, IND <br> 
			    	P.O. Box: 140413
			 		</p>
				</div>
				<div class="col-md-4">
					...
					<p>Subtotal: INR 356 <br>
					 Shipping fee:  INR 56 <br> 
					 <span class="b">Total:  INR 456 </span>
					</p>
				</div>
			</div> <!-- row.// -->
		</div> <!-- card-body .// -->
		...
		<table class="table table-hover">
			<tr>
				...
				<td> 
					...
					<var class="price text-muted">INR 145</var>
				</td>
			...
			<tr>
				...
				<td> 
					...
					<var class="price text-muted">INR 15</var>
				</td>
