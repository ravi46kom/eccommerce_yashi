				...
				<div class="row no-gutters">
					...
					<main class="col-md-6 border-left">
						<article class="content-body">
							...
							<div class="mb-3">
								<var class="price h4">815.00 INR</var>
							</div>
								...
								<div class="item-option-select">
									...
									<div class="btn-group btn-group-sm btn-group-toggle"
										...
										<label class="btn btn-light"> <input type="radio"
											name="radio_color"> Silver
										</label> <label class="btn btn-light"> <input type="radio"
											name="radio_color"> Gray
										</label> <label class="btn btn-light active"> <input
											type="radio" name="radio_color checked"> Gold
										</label> <label class="btn btn-light"> <input type="radio"
											name="radio_color"> Black
										</label>
									</div>
								</div>
							</div>
								...
								<div class="item-option-select">
									...
									<div class="btn-group btn-group-sm btn-group-toggle"
										...
										<label class="btn btn-light"> <input type="radio"
											...
											type="radio" name="radio_color" checked> M
										</label> <label class="btn btn-light"> <input type="radio"
											name="radio_color"> L
										</label> <label class="btn btn-light"> <input type="radio"
											name="radio_color"> XL
							...
							<!-- row.// -->
							<hr>
							<a href="./product-detail.jsp" class="btn  btn-primary"> <span
				...
				<div class="col-md-9">
					...
					<article class="box mb-3">
						<div class="icontext w-100">
							...
							<div class="text">
								<span class="date text-muted float-md-right">20.10.2022 </span>
						...
						<!-- icontext.// -->
						<div class="mt-3">
							<p>Dummy comment Lorem ipsum dolor sit amet, consectetur
